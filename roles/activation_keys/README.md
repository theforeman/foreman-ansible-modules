...
Label for Red Hat products for example (rhel-7-server-rpms).
Label for custom products it's in the format: (<organization_label>_<product_label>_<repositoryLabel>), e.g. C(ExampleOrg_ExampleCustomProduct_ExampleRepository).
