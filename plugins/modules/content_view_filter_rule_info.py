# content_view_filter_rule_info.py
# content_view_filter_info.py
#!/usr/bin/python
# -*- coding: utf-8 -*-
...
class KatelloContentViewFilterRuleInfo(ForemanInfoAnsibleModule):
    pass


def main():
    module = KatelloContentViewFilterRuleInfo(        foreman_spec=dict(
