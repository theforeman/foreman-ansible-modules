:source: foreman_os_default_template.py

:orphan:

.. _foreman_os_default_template_module:
        ...
        <tr>
            ...
            <th>Choices/<font color="blue">Defaults</font></th>
                    ...
                    <b>password</b>
                                ...
                                <tr>
                                                                <td colspan="1">
                    <b>provisioning_template</b>
                                                                            </td>
                                <td>
                                                                                                                                                            </td>
                                                                <td>
                                                                        <div>name of provisioning template</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    ...
                    <b>state</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>State of the Association</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
                    <b>template_kind</b>
                                ...
                                <td>
                                                                ...
                                                                <td>
                                                                        <div>name of the template kind</div>
                                                                                </td>
            </tr>
                                <tr>
                                                                <td colspan="1">
...
.. hint::
    If you notice any issues in this documentation you can `edit this document <https://github.com/theforeman/foreman-ansible-modules/edit/master/modules/foreman_os_default_template.py?description=%3C!---%20Your%20description%20here%20--%3E%0A%0A%2Blabel:%20docsite_pr>`_ to improve it.
